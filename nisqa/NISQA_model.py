...
from .sheduler.scheduler import earlyStopper, earlyStopper_dim, get_lr
...
class nisqaModel(object):
    ...
    def _train_dim(self):
        ...
        for epoch in range(self.args["tr_epochs"]):
            ...
            predict_dim(self.model, self.ds_val, self.args["tr_bs_val"], self.dev,
                           num_workers=self.args["tr_num_workers"])
    ...
    def _loadDatasetsFolder(self):
        files = glob(os.path.join(self.args["data_dir"], "*.mp3"))
